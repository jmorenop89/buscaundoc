									...
									<div class="row add_bottom_45">
										...
										<div class="col-lg-5">
											<div id="custom-search-input" class="">
						    					<div class=" ">
						        					<input type="text" class="especialidad" placeholder="Hora de Inicio">
						        					<input type="text" class="ciudad" placeholder="Hora de Cierrre">
						        					<input type="submit" class="buscar align-items-right" value="Guardar">
						    					</div>
						    				</div>
										</div>
										<div class="col-lg-12">
